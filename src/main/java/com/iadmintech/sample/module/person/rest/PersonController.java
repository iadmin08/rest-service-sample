...
public class PersonController {
    ...
    public @ResponseBody ResponseDtoWrapper<List<PersonDto>> getPerson(){
        ...
        return new ResponseDtoWrapper<>(personDtoList, null);
    }
    ...
    public @ResponseBody ResponseDtoWrapper<PersonDto> getPerson(@PathVariable("personId") Long personId){
        ...
        return new ResponseDtoWrapper<>(personDto, null);
    }

    @RequestMapping(value = "", method = RequestMethod.PUT)
    public @ResponseBody ResponseDtoWrapper<PersonDto> putPerson(@RequestBody RequestDtoWrapper<PersonDto> requestDtoWrapper) throws PersonDaoException {
        PersonDto returnPersonDto = personService.putPerson(requestDtoWrapper.getData());
        return new ResponseDtoWrapper<>(returnPersonDto, null);
    }
}
